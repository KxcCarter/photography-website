    ...
    <Wrapper>
      <div className="about">
        ...
        <p>
          ...
          Music Composition. He now lives and works in Boston, Massachusetts
          where he spends his free time composing, working on his screenplay,
          and forgetting to eat. His favorite composers include but are not
          limited to the following: Sergei Prokofiev, Howard Shore, Gustav
          Mahler, Philip Glass, Claude Debussy, Maurice Ravel, Johannes Brahms,
          Aram Khachaturian, Igor Stravinsky, Alexander Borodin, Manuel de
          Falla.
        </p>
      </div>
    </Wrapper>
